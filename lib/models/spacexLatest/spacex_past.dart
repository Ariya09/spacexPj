...
//
//     final spacexPast = spacexPastFromJson(jsonString);

import 'dart:convert';

List<SpacexPast> spacexPastFromJson(String str) =>
    List<SpacexPast>.from(json.decode(str).map((x) => SpacexPast.fromJson(x)));

String spacexPastToJson(List<SpacexPast> data) =>
...
class SpacexPast {
  ...
  factory SpacexPast.fromJson(Map<String, dynamic> json) => SpacexPast(
...
enum DatePrecision { DAY, HOUR }

final datePrecisionValues =
    EnumValues({"day": DatePrecision.DAY, "hour": DatePrecision.HOUR});
